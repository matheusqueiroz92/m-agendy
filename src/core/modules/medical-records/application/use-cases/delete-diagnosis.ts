...
export interface DeleteDiagnosisInput {
  actor: AuthenticatedActor | null;
  clinicId: string;
  diagnosisId: string;
}

/** Remove um diagnóstico, validando isolamento por clínica e auditando. */
