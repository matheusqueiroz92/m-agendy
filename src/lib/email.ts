  ...
  const html = `
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          <h2>Olá, ${userName}!</h2>
          <p>Obrigado por se cadastrar no M.Agendy. Para completar seu cadastro e começar a usar nossa plataforma, você precisa verificar seu endereço de e-mail.</p>
          ...
          <p>Se você não criou uma conta no M.Agendy, pode ignorar este e-mail com segurança.</p>
        </div>
        <div class="footer">
